		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
					...
					<li><a href="${pageContext.request.contextPath}/${blogVo.blogId}/blog/admin/write">글작성</a></li>
				</ul>
				<form method="post"action="${pageContext.request.contextPath }/${blogVo.blogId}/admin/basic/update" enctype="multipart/form-data">
